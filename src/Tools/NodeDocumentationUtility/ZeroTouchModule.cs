...
namespace NodeDocumentationUtility
{
    class ZeroTouchModule
    {
        ...
        {
            var core = CreateCore();
            //var library = new LibraryServices(core);
            //library.ImportLibrary(assembly);
        ...
        private static Core CreateCore()
        {
            ...
            core.Executives.Add(Language.kAssociative, new ProtoAssociative.Executive(core));
            //core.Executives.Add(Language.kImperative, new ProtoImperative.Executive(core));
