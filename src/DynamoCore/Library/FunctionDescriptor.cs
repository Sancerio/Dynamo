...
namespace Dynamo.DSEngine
{
    ...
    public class FunctionDescriptor : IFunctionDescriptor
    {
        ...
        public FunctionDescriptor(
            ...
            IEnumerable<string> returnKeys = null, bool isVarArg = false, string obsoleteMsg = /*NXLT*/"")
            : this(
                assembly,
                className,
                functionName,
        ...
        public FunctionDescriptor(
            ...
            bool isVisibleInLibrary = true, IEnumerable<string> returnKeys = null, bool isVarArg = false, string obsoleteMsg = /*NXLT*/"")
        {
